...
<!-- 
    SVN: $Id: Imvert-common-parms.xsl 7417 2016-02-09 13:01:46Z arjan $ 
-->
<xsl:stylesheet 
    ...
    <xsl:param name="stylesheet"/> <!-- set by the client stylesheet -->
    <xsl:param name="stylesheet-version"/> <!-- set by the client stylesheet -->

...
<!-- 
    SVN: $Id: Tester.xsl 7295 2015-11-04 11:24:37Z arjan $ 
-->
<xsl:stylesheet 
    ...
    <xsl:variable name="stylesheet">Tester.xsl</xsl:variable>
    <xsl:variable name="stylesheet-version">$Id: Tester.xsl 7295 2015-11-04 11:24:37Z arjan $</xsl:variable>
    ...
    <xsl:template match="/*">
        ...
        <result>
            <messaging>
                ...
                <xsl:message>
                    <xsl:sequence select="imf:create-output-element('src',$stylesheet)"/>

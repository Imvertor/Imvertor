...
<!-- 
    SVN: $Id: Imvert2validation-KING.xsl 7371 2016-01-11 11:07:16Z arjan $ 
-->
<xsl:stylesheet 
    ...
    <xsl:variable name="stylesheet">Imvert2validation-KING</xsl:variable>
    <xsl:variable name="stylesheet-version">$Id: Imvert2validation-KING.xsl 7371 2016-01-11 11:07:16Z arjan $</xsl:variable>

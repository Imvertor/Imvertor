...
<!-- 
    SVN: $Id: Imvert2validation-Kadaster.xsl 7402 2016-02-02 13:55:57Z arjan $ 
-->
<xsl:stylesheet 
    ...
    <xsl:variable name="stylesheet">Imvert2validation-Kadaster</xsl:variable>
    <xsl:variable name="stylesheet-version">$Id: Imvert2validation-Kadaster.xsl 7402 2016-02-02 13:55:57Z arjan $</xsl:variable>

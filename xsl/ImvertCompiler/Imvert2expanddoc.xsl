...
<!-- 
    SVN: $Id: Imvert2expanddoc.xsl 7395 2016-01-26 10:35:23Z arjan $ 
-->
<xsl:stylesheet 
    ...
    <!-- 
       ...
       If found, test if actually avialbale there. 
    -->
    ...
    <xsl:variable name="stylesheet">Imvert2expanddoc</xsl:variable>
    <xsl:variable name="stylesheet-version">$Id: Imvert2expanddoc.xsl 7395 2016-01-26 10:35:23Z arjan $</xsl:variable>

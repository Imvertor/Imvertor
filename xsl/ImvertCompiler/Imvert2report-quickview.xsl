...
<!-- 
    SVN: $Id: Imvert2report-quickview.xsl 7277 2015-09-24 09:15:57Z arjan $ 
-->
<xsl:stylesheet 
    ...
    <xsl:template match="imvert:packages" mode="quickview">
        <xsl:variable name="domain-packages" select="root()//imvert:package[imvert:stereotype=imf:get-config-stereotypes('stereotype-name-domain-package')]"/>

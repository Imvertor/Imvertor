...
<!-- 
    SVN: $Id: Imvert2compare-simplify.xsl 7421 2016-02-10 10:31:52Z arjan $ 
-->
<xsl:stylesheet 
    ...
    <xsl:variable name="stylesheet-version">$Id: Imvert2compare-simplify.xsl 7421 2016-02-10 10:31:52Z arjan $</xsl:variable>

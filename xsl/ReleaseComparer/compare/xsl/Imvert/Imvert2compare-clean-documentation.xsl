...
<!-- 
    SVN: $Id: Imvert2compare-clean-documentation.xsl 7228 2015-09-01 13:24:51Z arjan $ 
-->
<xsl:stylesheet 
    ...
    <!-- 
       Compare two Imvert result files. See Jira IM-147 "Documentatie release ondersteunen"  
    -->
    ...
    <xsl:variable name="stylesheet-version">$Id: Imvert2compare-clean-documentation.xsl 7228 2015-09-01 13:24:51Z arjan $</xsl:variable>

...
public class ConceptCollector extends Step {
	...
	public static final String VC_IDENTIFIER = "$Id: ConceptCollector.java 7340 2015-12-06 13:46:20Z arjan $";
	...
	public boolean run() {
		...
		try {
		    ...
		    if ( forc || must || finl ) {
				...
				//TODO this extracts the RDF XML to a location in the managed input folder. Better is to check the common managed input folder, copy that and procesds, or recomnpile when not available in common input folder?
